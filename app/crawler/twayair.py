...
class TwayData():
    ...
    def monthpicker(self, month):
        elements = self.driver.find_elements_by_xpath("//*[@id='onwardDatepicker']/div/div[2]/div/div/select[1]/option")
    ...
    def datepicker(self, date):
        elements = self.driver.find_elements_by_xpath("//*[@id='onwardDatepicker']/div/div[2]/div/table/tbody/tr/td/a")

        for dates in elements:
            print(dates.get_attribute("title"))
